...
fileU   = fn.File(mesh.mpi_comm(), "Output/2_5_1_Footing_floor_removed/u.pvd")
filePHI = fn.File(mesh.mpi_comm(), "Output/2_5_1_Footing_floor_removed/phi.pvd")
fileP   = fn.File(mesh.mpi_comm(), "Output/2_5_1_Footing_floor_removed/p.pvd")
